            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Manage Batch Type</li>
                    </ol>
                </section>
                                    ...
                                    <div class="box-body">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="brt_name" id="brt_name"  placeholder="Enter Batch Type Name" value="<?php echo $brt_name; ?>" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- /.box-body -->
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align="center"><a href="manage_batchtype.php?page=<?php echo $page; ?>&per_page=<?php echo $per_page; ?>&order_by=brt_name&order=<?php echo $order; ?>">Batch Type Name <span class="<?php echo $brt_name_arrow; ?>"></span></a></th>
                                                <!-- <th align="center" width="80px">Days</th> -->
                                                <th align="center" width="80px">Course Amount</th>
