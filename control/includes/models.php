                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class=" col-md-12">
                            ...
                            <!-- <div class="model-course-help">
                                <label class="col-sm-3 control-label">C. End Date</label>
                                <div class="col-sm-9">
                                    <input type="text" readonly name="a_sc_end_date" id="a_sc_end_date"
                                        placeholder="Ending Date" value="<?php echo DBtoDisp($cur_date); ?>"
                                        class="form-control" />
                                </div>
                            </div> -->
                            <div class="model-course-help">
    ...
    if (ans_v == true) {
        ...
        $.ajax({
            ...
            data: {
                ...
                a_sc_end_date:$("#a_sc_end_date").val(),
...
<div class="modal" id="pay_fee_student">
                    ...
                    <div class="box-body">
                        <div class=" col-md-12">
                            ...
                            <div class="model-course-help">
                                ...
                                <div class="col-sm-9">
                                    <select id="pt_ac_id" name="pt_ac_id" class="form-control" onchange="getpaymentmodevalue();">
                                        <option value="0">--Please select--</option>
                                        <?php
                                          $data_arr_input = array();
 ...
 // Get references to the Account and Payment Mode dropdowns
 function getpaymentmodevalue() {
