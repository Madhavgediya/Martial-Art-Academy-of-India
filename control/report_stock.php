...
$pageObj = new PS_Pagination($table, $select, "$condition", $per_page, 5, "qty_status=" . $qty_status  . $searchField . "&order by=" . $order_by . "&order=" . $order);
                                    ...
                                    <button type="button" class="btn btn-warning pull-right" onclick="product_qty_manager_toggle('Dead Stock');" style="margin-left: 5px;">Dead Stock</button>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" onclick="print_attendance('print_me', '<?php echo $arr_branch_details["name"]; ?>', 'report_stock', '');">Export to PDF</a></li>
                    ...
                    <div class="row" >
                        <div class="col-xs-12">
                            <!-- <ul class="nav nav-tabs">
                                <li class="active"><a href="report_stock.php?qty_status=All" class="btn btn-default">All</a></li>
                                <li><a href="report_stock.php?qty_status=Current Stock" class="btn btn-default">Current Stock</a></li>
                                <li><a href="report_stock.php?qty_status=Out of Stock" class="btn btn-default">Out of Stock</a></li>
                                <li><a href="report_stock.php?qty_status=Office Item" class="btn btn-default">Office Item</a><li>
                                <li><a href="report_stock.php?qty_status=Dead Stock" class="btn btn-default">Dead Stock</a></li>
                            </ul> -->
                            <ul id="stockTabs" class="nav nav-tabs">
                                <li><a href="report_stock.php?qty_status=All" class="btn btn-default">All</a></li>
                                <li><a href="report_stock.php?qty_status=Current Stock" class="btn btn-default">Current Stock</a></li>
                                <li><a href="report_stock.php?qty_status=Out of Stock" class="btn btn-default">Out of Stock</a></li>
                                <li><a href="report_stock.php?qty_status=Office Item" class="btn btn-default">Office Item</a></li>
                                <li><a href="report_stock.php?qty_status=Dead Stock" class="btn btn-default">Dead Stock</a></li>
                            ...
                            <div class="box">                                
                                <div class="box-body">
                                <p class="lead text-center mid_caption"><?php echo $qty_status;?></p> 
    ...
    <?php include("includes/footer.php"); ?>
        ...
        <script>
            function exportToExcel()
            {
                ...
                a.href = url;
                var stockStatus=<?php echo json_encode($qty_status);?>;
                if(stockStatus=='All'){
                    a.download=stockStatus+'_Stock_report.xls';
                }
                else{
                    a.download = stockStatus+'.xls';
                }
