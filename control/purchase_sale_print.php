                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                ...
                                <img src="dist/img/logo.png" width="90px" height="90px" style="float:left;" />
                                    <br>
                                    <center>
                                    <h3 class="box-title"><?php echo $caption; ?></h3><br><br><strong>web:</strong>www.martialartacademyofindia.com</center>
